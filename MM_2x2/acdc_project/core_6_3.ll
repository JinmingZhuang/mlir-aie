...
define void @core63() !dbg !3 {
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([1024 x i32]* @buf64_0 to i64), i64 31), i64 0)), !dbg !7
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([1024 x i32]* @buf64_1 to i64), i64 31), i64 0)), !dbg !9
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([1024 x i32]* @buf64_2 to i64), i64 31), i64 0)), !dbg !10
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([1024 x i32]* @buf63_0 to i64), i64 31), i64 0)), !dbg !11
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([1024 x i32]* @buf63_1 to i64), i64 31), i64 0)), !dbg !12
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([1024 x i32]* @buf63_2 to i64), i64 31), i64 0)), !dbg !13
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([1024 x i32]* @buf63_3 to i64), i64 31), i64 0)), !dbg !14
  call void @llvm.aie.lock.acquire.reg(i32 48, i32 1), !dbg !15
  call void @llvm.aie.lock.acquire.reg(i32 49, i32 1), !dbg !16
  call void @llvm.aie.lock.acquire.reg(i32 51, i32 0), !dbg !17
  call void @extern_kernel(i32* getelementptr inbounds ([1024 x i32], [1024 x i32]* @buf63_0, i64 0, i64 0), i32* getelementptr inbounds ([1024 x i32], [1024 x i32]* @buf63_1, i64 0, i64 0), i32* getelementptr inbounds ([1024 x i32], [1024 x i32]* @buf63_2, i64 0, i64 0), i32* getelementptr inbounds ([1024 x i32], [1024 x i32]* @buf63_3, i64 0, i64 0)), !dbg !18
  call void @llvm.aie.lock.release.reg(i32 51, i32 1), !dbg !19
  ret void, !dbg !20
}

define void @_main() !dbg !21 {
  call void @core63(), !dbg !22
  ret void, !dbg !24
}
...
!3 = distinct !DISubprogram(name: "core63", linkageName: "core63", scope: null, file: !4, line: 21, type: !5, scopeLine: 21, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !6)
!4 = !DIFile(filename: "acdc_project/core_6_3.opt.mlir", directory: "/proj/rdi/staff/jinmingz/nobkup/mlir-aie/test/unit_tests/chess_compiler_tests/MM_2x2")
