module @test_single_kernel attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.func @core64() {
    ...
    %28 = llvm.mlir.addressof @buf64_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %33 = llvm.mlir.addressof @buf64_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %38 = llvm.mlir.addressof @buf64_2 : !llvm.ptr<array<1024 x i32>>
    ...
    %43 = llvm.mlir.addressof @buf74_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %48 = llvm.mlir.addressof @buf74_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %53 = llvm.mlir.addressof @buf74_2 : !llvm.ptr<array<1024 x i32>>
    ...
    llvm.call @extern_kernel(%29, %34, %24, %39) : (!llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>) -> ()
