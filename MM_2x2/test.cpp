...
//
    ...
    mlir_aie_release_lock(_xaie, 6, 3, 3, 0, 0);
    ...
    while ((tries0 < 1000) && (!mlir_aie_acquire_lock(_xaie, 6, 4, 2, 1, 0))) {
      tries0++;
    }
    ...
    for (int bd=0;bd<DMA_COUNT;bd++) {
        ...
        mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf74_2(_xaie, bd), 161,
                   errors);
        mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf63_0(_xaie, bd), 1,
                   errors);
        mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf63_1(_xaie, bd), 1,
                   errors);
        mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf64_0(_xaie, bd), 2,
                       errors);
        mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf64_1(_xaie, bd), 2,
                   errors);
    ...
    mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf64_1(_xaie, 1023), 2,
               errors);
    mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf63_3(_xaie, 1023),33,
                   errors);
    mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf64_2(_xaie, 1023), 161,
                   errors);
