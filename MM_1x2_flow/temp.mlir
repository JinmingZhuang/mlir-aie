module @test_single_kernel {
  ...
  %8 = AIE.buffer(%2) {sym_name = "buf72_0"} : memref<1024xi32>
  %9 = AIE.buffer(%2) {sym_name = "buf72_1"} : memref<1024xi32>
  %10 = AIE.buffer(%2) {sym_name = "buf72_2"} : memref<1024xi32>
  %11 = AIE.buffer(%2) {sym_name = "buf72_3"} : memref<1024xi32>
  %12 = AIE.buffer(%4) {sym_name = "buf73_0"} : memref<1024xi32>
  %13 = AIE.buffer(%4) {sym_name = "buf73_1"} : memref<1024xi32>
  %14 = AIE.buffer(%4) {sym_name = "buf73_2"} : memref<1024xi32>
  %15 = AIE.buffer(%4) {sym_name = "buf73_3"} : memref<1024xi32>
  %16 = AIE.buffer(%6) {sym_name = "buf74_0"} : memref<1024xi32>
  %17 = AIE.buffer(%6) {sym_name = "buf74_1"} : memref<1024xi32>
  %18 = AIE.buffer(%6) {sym_name = "buf74_2"} : memref<1024xi32>
  %19 = AIE.mem(%2) {
    %30 = AIE.lock(%2, 4)
    %31 = AIE.lock(%2, 5)
    %32 = AIE.lock(%2, 6)
