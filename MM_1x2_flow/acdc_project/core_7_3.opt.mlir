module @test_single_kernel attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.func @core73() {
    ...
    %5 = llvm.mlir.addressof @buf74_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %12 = llvm.mlir.addressof @buf74_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %17 = llvm.mlir.addressof @buf74_2 : !llvm.ptr<array<1024 x i32>>
    ...
    %22 = llvm.mlir.addressof @buf73_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %27 = llvm.mlir.addressof @buf73_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %32 = llvm.mlir.addressof @buf73_2 : !llvm.ptr<array<1024 x i32>>
    ...
    %37 = llvm.mlir.addressof @buf73_3 : !llvm.ptr<array<1024 x i32>>
    ...
    %42 = llvm.mlir.addressof @buf72_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %47 = llvm.mlir.addressof @buf72_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %52 = llvm.mlir.addressof @buf72_2 : !llvm.ptr<array<1024 x i32>>
    ...
    %57 = llvm.mlir.addressof @buf72_3 : !llvm.ptr<array<1024 x i32>>
    ...
    llvm.call @extern_kernel(%23, %28, %33, %38) : (!llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>) -> ()
