module @test_single_kernel attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.func @core72() {
    ...
    %6 = llvm.mlir.addressof @a : !llvm.ptr<array<1024 x i32>>
    ...
    %13 = llvm.mlir.addressof @b : !llvm.ptr<array<1024 x i32>>
    ...
    %18 = llvm.mlir.addressof @acc : !llvm.ptr<array<1024 x i32>>
    ...
    %23 = llvm.mlir.addressof @c : !llvm.ptr<array<1024 x i32>>
