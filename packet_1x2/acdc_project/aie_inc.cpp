...
XAieDma_TileBdSetPkt(&(ctx->TileDMAInst[7][2]),  /* bd */ 0,  /* en */ 1,  /* type */ 4,  /* id */ 12);
...
XAieDma_TileBdSetPkt(&(ctx->TileDMAInst[7][4]),  /* bd */ 0,  /* en */ 1,  /* type */ 5,  /* id */ 13);
...
XAieDma_ShimBdSetAddr(&ShimDMAInst_7_0,  /* bd */ 0, HIGH_ADDR((u64)0x20100004000), LOW_ADDR((u64)0x20100004000),  /* len */ 257 * 4);
...
XAieDma_ShimBdSetAddr(&ShimDMAInst_7_0,  /* bd */ 1, HIGH_ADDR((u64)0x20100005000), LOW_ADDR((u64)0x20100005000),  /* len */ 257 * 4);
...
XAieTile_StrmConfigMstr(&(ctx->TileInst[x][y]),
	...
	XAIETILE_STRSW_MPORT_CFGPKT(&(ctx->TileInst[x][y]),
		...
		1 /*arbiter*/));
XAieTile_StrmConfigMstr(&(ctx->TileInst[x][y]),
	XAIETILE_STRSW_MPORT_NORTH(&(ctx->TileInst[x][y]), 3),
	XAIE_ENABLE,
	XAIE_ENABLE,
	XAIETILE_STRSW_MPORT_CFGPKT(&(ctx->TileInst[x][y]),
		XAIETILE_STRSW_MPORT_NORTH(&(ctx->TileInst[x][y]), 3),
