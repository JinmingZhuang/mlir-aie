module @test_single_kernel {
  ...
  %2 = AIE.tile(7, 3)
  %3 = AIE.tile(7, 4)
  %4 = AIE.buffer(%1) {address = 4096 : i32, sym_name = "buf72_0"} : memref<1024xi32>
  %5 = AIE.buffer(%1) {address = 8192 : i32, sym_name = "buf72_1"} : memref<1024xi32>
  %6 = AIE.buffer(%1) {address = 12288 : i32, sym_name = "buf72_2"} : memref<1024xi32>
  %7 = AIE.buffer(%1) {address = 16384 : i32, sym_name = "buf72_3"} : memref<1024xi32>
  ...
  AIE.wire(%110 : North, %75 : South)
  AIE.wire(%104 : North, %110 : South)
  AIE.wire(%39 : DMA, %110 : DMA)
  ...
  AIE.wire(%111 : North, %80 : South)
  AIE.wire(%105 : North, %111 : South)
  AIE.wire(%44 : DMA, %111 : DMA)
  ...
  AIE.wire(%112 : North, %95 : South)
  AIE.wire(%108 : North, %112 : South)
  AIE.wire(%59 : DMA, %112 : DMA)
