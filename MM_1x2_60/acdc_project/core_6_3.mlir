module @test_single_kernel attributes {llvm.target_triple = "aie"} {
  ...
  memref.global "public" @buf62_0 : memref<1024xi32>
  memref.global "public" @buf62_1 : memref<1024xi32>
  memref.global "public" @buf62_2 : memref<1024xi32>
  memref.global "public" @buf62_3 : memref<1024xi32>
  ...
  func @core63() {
    ...
    %7 = memref.get_global @buf62_0 : memref<1024xi32>
    memref.assume_alignment %7, 32 : memref<1024xi32>
    %8 = memref.get_global @buf62_1 : memref<1024xi32>
    memref.assume_alignment %8, 32 : memref<1024xi32>
    %9 = memref.get_global @buf62_2 : memref<1024xi32>
    memref.assume_alignment %9, 32 : memref<1024xi32>
    %10 = memref.get_global @buf62_3 : memref<1024xi32>
