...
XAie_DmaSetLock(&(dma_tile72_bd1), XAie_LockInit(1,1),XAie_LockInit(1,0));
XAie_DmaSetAddrLen(&(dma_tile72_bd1),  /* addrA */ 0x1000,  /* len */ 256 * 4);
XAie_DmaSetNextBd(&(dma_tile72_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1);
XAie_DmaSetPkt(&(dma_tile72_bd1), XAie_PacketInit(13,1));
...
XAie_DmaChannelPushBdToQueue(&(ctx->DevInst), XAie_TileLoc(7,2), /* ChNum */0, /* dmaDir */ DMA_MM2S, /* BdNum */1);
...
XAie_DmaSetPkt(&(dma_tile74_bd0), XAie_PacketInit(13,1));
...
x = 7;
y = 2;
XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), DMA, 0, NORTH, 3);
...
XAie_StrmPktSwMstrPortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), DMA, 0, /* drop_header */ XAIE_SS_PKT_DROP_HEADER, /* arbiter */ 1, /* MSelEn */ 1);
XAie_StrmPktSwSlavePortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 3);
XAie_StrmPktSwSlaveSlotEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 3, /* slot */ 0, /* packet */ XAie_PacketInit(13,0), /* mask */ 0x1F, /* msel */ 0, /* arbiter */ 1);
