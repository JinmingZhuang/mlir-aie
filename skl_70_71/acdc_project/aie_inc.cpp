...
{
int ret = XAieGbl_LoadElf(&(ctx->TileInst[7][1]), (u8*)"core_7_1.elf", XAIE_ENABLE);
if (ret == XAIELIB_FAILURE)
printf("Failed to load elf for Core[%d,%d], ret is %d", 7, 1, ret);
...
XAieDma_TileInitialize(&(ctx->TileInst[7][1]), &(ctx->TileDMAInst[7][1]));
XAieDma_TileBdClearAll(&(ctx->TileDMAInst[7][1]));
XAieDma_TileChResetAll(&(ctx->TileDMAInst[7][1]));
XAieDma_TileBdSetLock(&(ctx->TileDMAInst[7][1]),  /* bd */ 0, XAIEDMA_TILE_BD_ADDRA,  /* lockID */ 0, XAIE_ENABLE,  /* release */ 1, XAIE_ENABLE,  /* acquire */ 0);
XAieDma_TileBdSetAdrLenMod(&(ctx->TileDMAInst[7][1]),  /* bd */ 0,  /* addrA */ 0x1000,  /* addrB */ 0x0,  /* len */ 1024 * 4,  /* ABMode */ XAIE_DISABLE,  /* FIFOMode */ XAIE_DISABLE);
XAieDma_TileBdSetNext(&(ctx->TileDMAInst[7][1]),  /* bd */ 0,  /* nextbd */ 0);
XAieDma_TileBdWrite(&(ctx->TileDMAInst[7][1]),  /* bd */ 0);
XAieDma_TileBdSetLock(&(ctx->TileDMAInst[7][1]),  /* bd */ 1, XAIEDMA_TILE_BD_ADDRA,  /* lockID */ 1, XAIE_ENABLE,  /* release */ 1, XAIE_ENABLE,  /* acquire */ 0);
XAieDma_TileBdSetAdrLenMod(&(ctx->TileDMAInst[7][1]),  /* bd */ 1,  /* addrA */ 0x2000,  /* addrB */ 0x0,  /* len */ 1024 * 4,  /* ABMode */ XAIE_DISABLE,  /* FIFOMode */ XAIE_DISABLE);
XAieDma_TileBdSetNext(&(ctx->TileDMAInst[7][1]),  /* bd */ 1,  /* nextbd */ 1);
XAieDma_TileBdWrite(&(ctx->TileDMAInst[7][1]),  /* bd */ 1);
XAieDma_TileSetStartBd((&(ctx->TileDMAInst[7][1])), XAIEDMA_TILE_CHNUM_S2MM0,  /* bd */ 0);
XAieDma_TileChControl(&(ctx->TileDMAInst[7][1]), XAIEDMA_TILE_CHNUM_S2MM0, XAIE_RESETDISABLE, XAIE_ENABLE);
XAieDma_TileSetStartBd((&(ctx->TileDMAInst[7][1])), XAIEDMA_TILE_CHNUM_S2MM1,  /* bd */ 1);
XAieDma_TileChControl(&(ctx->TileDMAInst[7][1]), XAIEDMA_TILE_CHNUM_S2MM1, XAIE_RESETDISABLE, XAIE_ENABLE);
...
XAieDma_ShimBdSetAddr(&ShimDMAInst_7_0,  /* bd */ 0, HIGH_ADDR((u64)0x20100004000), LOW_ADDR((u64)0x20100004000),  /* len */ 1024 * 4);
...
XAieDma_ShimBdSetAddr(&ShimDMAInst_7_0,  /* bd */ 1, HIGH_ADDR((u64)0x20100006000), LOW_ADDR((u64)0x20100006000),  /* len */ 1024 * 4);
