module @test_single_kernel attributes {llvm.target_triple = "aie"} {
  ...
  func @core13() {
    ...
    %5 = arith.index_cast %c32 : index to i32
    %c0_i32 = arith.constant 0 : i32
    call @llvm.aie.lock.acquire.reg(%5, %c0_i32) : (i32, i32) -> ()
    call @extern_kernel(%0, %1, %2, %3) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
    %6 = arith.index_cast %c48 : index to i32
    %c0_i32_0 = arith.constant 0 : i32
    call @llvm.aie.lock.release.reg(%6, %c0_i32_0) : (i32, i32) -> ()
