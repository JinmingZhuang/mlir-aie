...
define void @core72() !dbg !3 {
  ...
  call void @llvm.aie.lock.acquire.reg(i32 16, i32 1), !dbg !12
  call void @llvm.aie.lock.acquire.reg(i32 17, i32 1), !dbg !13
...
!4 = !DIFile(filename: "acdc_project/core_7_2.opt.mlir", directory: "/proj/rdi/staff/jinmingz/nobkup/mlir-aie/test/unit_tests/chess_compiler_tests/2021.2_Pro/skl_71_72")
