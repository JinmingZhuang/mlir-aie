...
XAie_StrmPktSwMstrPortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), NORTH, 3, /* drop_header */ XAIE_SS_PKT_DROP_HEADER, /* arbiter */ 2, /* MSelEn */ 1);
...
XAie_StrmPktSwSlavePortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 3);
XAie_StrmPktSwSlaveSlotEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 3, /* slot */ 1, /* packet */ XAie_PacketInit(13,0), /* mask */ 0x1F, /* msel */ 0, /* arbiter */ 2);
...
x = 7;
y = 1;
XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 0, NORTH, 3);
