...
XAie_DmaSetLock(&(dma_tile72_bd1), XAie_LockInit(2,0),XAie_LockInit(2,1));
XAie_DmaSetAddrLen(&(dma_tile72_bd1),  /* addrA */ 0x1400,  /* len */ 256 * 4);
