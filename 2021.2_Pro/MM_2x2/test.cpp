...
//
    ...
    mlir_aie_clear_tile_memory(_xaie, 5, 3);
    mlir_aie_clear_tile_memory(_xaie, 5, 4);
    ...
    for (int bd=0;bd<DMA_COUNT;bd++) {
        ...
        mlir_aie_write_buffer_buf53_2(_xaie, bd, 1);
    }
    ...
    mlir_aie_release_lock(_xaie, 5, 3, 0, 0, 0);
    mlir_aie_release_lock(_xaie, 5, 3, 1, 0, 0);
    mlir_aie_release_lock(_xaie, 5, 3, 2, 1, 0);

    mlir_aie_release_lock(_xaie, 5, 4, 0, 0, 0);
    mlir_aie_release_lock(_xaie, 5, 4, 1, 0, 0);
    mlir_aie_release_lock(_xaie, 5, 4, 2, 0, 0);
    ...
    mlir_aie_print_tile_status(_xaie, 5, 3);
    mlir_aie_print_tile_status(_xaie, 5, 4);
    ...
    while ((tries0 < 1000) && (!mlir_aie_acquire_lock(_xaie, 5, 4, 2, 1, 0))) {
      tries0++;
    }
    ...
    for (int bd=0;bd<DMA_COUNT;bd++) {
        ...
        mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf74_2(_xaie, bd), 161,
                   errors);
        mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf53_0(_xaie, bd), 1,
                   errors);
        mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf53_1(_xaie, bd), 1,
                   errors);
        mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf54_0(_xaie, bd), 2,
                       errors);
        mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf54_1(_xaie, bd), 2,
                   errors);
    ...
    mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf74_1(_xaie, 1023), 2,
               errors);
    mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf53_0(_xaie, 1023), 1,
                   errors);
    mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf53_1(_xaie, 1023), 1,
               errors);
    mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf54_0(_xaie, 1023), 2,
                   errors);
    mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf54_1(_xaie, 1023), 2,
               errors);
    mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf53_3(_xaie, 1023),33,
                   errors);
    mlir_aie_check("Before release lock:", mlir_aie_read_buffer_buf54_2(_xaie, 1023), 161,
                   errors);
