module @test_single_kernel attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.func @core54() {
    ...
    %6 = llvm.mlir.addressof @buf54_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %13 = llvm.mlir.addressof @buf54_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %18 = llvm.mlir.addressof @buf54_2 : !llvm.ptr<array<1024 x i32>>
    ...
    %23 = llvm.mlir.addressof @buf53_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %28 = llvm.mlir.addressof @buf53_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %33 = llvm.mlir.addressof @buf53_2 : !llvm.ptr<array<1024 x i32>>
    ...
    %38 = llvm.mlir.addressof @buf53_3 : !llvm.ptr<array<1024 x i32>>
