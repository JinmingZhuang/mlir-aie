...
{
int ret = XAieGbl_LoadElf(&(ctx->TileInst[7][2]), (u8*)"core_7_2.elf", XAIE_ENABLE);
...
XAieDma_TileBdSetLock(&(ctx->TileDMAInst[7][2]),  /* bd */ 0, XAIEDMA_TILE_BD_ADDRA,  /* lockID */ 2, XAIE_ENABLE,  /* release */ 1, XAIE_ENABLE,  /* acquire */ 0);
...
XAieDma_TileBdSetLock(&(ctx->TileDMAInst[7][2]),  /* bd */ 1, XAIEDMA_TILE_BD_ADDRA,  /* lockID */ 3, XAIE_ENABLE,  /* release */ 1, XAIE_ENABLE,  /* acquire */ 0);
XAieDma_TileBdSetAdrLenMod(&(ctx->TileDMAInst[7][2]),  /* bd */ 1,  /* addrA */ 0x1400,  /* addrB */ 0x0,  /* len */ 256 * 4,  /* ABMode */ XAIE_DISABLE,  /* FIFOMode */ XAIE_DISABLE);
...
XAieDma_TileSetStartBd((&(ctx->TileDMAInst[7][2])), XAIEDMA_TILE_CHNUM_S2MM1,  /* bd */ 1);
XAieDma_TileChControl(&(ctx->TileDMAInst[7][2]), XAIEDMA_TILE_CHNUM_S2MM1, XAIE_RESETDISABLE, XAIE_ENABLE);
...
XAieDma_TileBdSetLock(&(ctx->TileDMAInst[7][3]),  /* bd */ 0, XAIEDMA_TILE_BD_ADDRA,  /* lockID */ 2, XAIE_ENABLE,  /* release */ 1, XAIE_ENABLE,  /* acquire */ 0);
XAieDma_TileBdSetAdrLenMod(&(ctx->TileDMAInst[7][3]),  /* bd */ 0,  /* addrA */ 0x1000,  /* addrB */ 0x0,  /* len */ 256 * 4,  /* ABMode */ XAIE_DISABLE,  /* FIFOMode */ XAIE_DISABLE);
XAieDma_TileBdSetNext(&(ctx->TileDMAInst[7][3]),  /* bd */ 0,  /* nextbd */ 0);
XAieDma_TileBdWrite(&(ctx->TileDMAInst[7][3]),  /* bd */ 0);
XAieDma_TileBdSetLock(&(ctx->TileDMAInst[7][3]),  /* bd */ 1, XAIEDMA_TILE_BD_ADDRA,  /* lockID */ 3, XAIE_ENABLE,  /* release */ 0, XAIE_ENABLE,  /* acquire */ 1);
XAieDma_TileBdSetAdrLenMod(&(ctx->TileDMAInst[7][3]),  /* bd */ 1,  /* addrA */ 0x1400,  /* addrB */ 0x0,  /* len */ 256 * 4,  /* ABMode */ XAIE_DISABLE,  /* FIFOMode */ XAIE_DISABLE);
...
XAieDma_TileSetStartBd((&(ctx->TileDMAInst[7][3])), XAIEDMA_TILE_CHNUM_MM2S0,  /* bd */ 1);
XAieDma_TileChControl(&(ctx->TileDMAInst[7][3]), XAIEDMA_TILE_CHNUM_MM2S0, XAIE_RESETDISABLE, XAIE_ENABLE);
...
XAieDma_ShimBdSetLock(&ShimDMAInst_7_0,  /* bd */ 1,  /* lockID */ 2, XAIE_ENABLE,  /* release */ 0, XAIE_ENABLE,  /* acquire */ 1);
XAieDma_ShimBdSetAddr(&ShimDMAInst_7_0,  /* bd */ 1, HIGH_ADDR((u64)0x20100005000), LOW_ADDR((u64)0x20100005000),  /* len */ 256 * 4);
XAieDma_ShimBdSetAxi(&ShimDMAInst_7_0, /* bd */ 1, /* smid */ 0, /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0, /* secure */ XAIE_ENABLE);
XAieDma_ShimBdSetNext(&ShimDMAInst_7_0,  /* bd */ 1,  /* nextbd */ 1);
XAieDma_ShimBdWrite(&ShimDMAInst_7_0,  /* bd */ 1);
...
XAieDma_ShimSetStartBd(&ShimDMAInst_7_0, XAIEDMA_SHIM_CHNUM_MM2S1,  /* bd */ 1);
XAieDma_ShimChControl(&ShimDMAInst_7_0, XAIEDMA_TILE_CHNUM_MM2S1, /* PauseStream */ XAIE_DISABLE, /* PauseMM */ XAIE_DISABLE, /* Enable */ XAIE_ENABLE);
XAieDma_Shim ShimDMAInst_6_0;
XAieDma_ShimInitialize(&(ctx->TileInst[6][0]), &ShimDMAInst_6_0);
XAieDma_ShimBdSetLock(&ShimDMAInst_6_0,  /* bd */ 0,  /* lockID */ 1, XAIE_ENABLE,  /* release */ 0, XAIE_ENABLE,  /* acquire */ 1);
XAieDma_ShimBdSetAddr(&ShimDMAInst_6_0,  /* bd */ 0, HIGH_ADDR((u64)0x20100006000), LOW_ADDR((u64)0x20100006000),  /* len */ 256 * 4);
XAieDma_ShimBdSetAxi(&ShimDMAInst_6_0, /* bd */ 0, /* smid */ 0, /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0, /* secure */ XAIE_ENABLE);
XAieDma_ShimBdSetNext(&ShimDMAInst_6_0,  /* bd */ 0,  /* nextbd */ 0);
XAieDma_ShimBdWrite(&ShimDMAInst_6_0,  /* bd */ 0);
XAieDma_ShimBdSetLock(&ShimDMAInst_6_0,  /* bd */ 1,  /* lockID */ 2, XAIE_ENABLE,  /* release */ 1, XAIE_ENABLE,  /* acquire */ 0);
XAieDma_ShimBdSetAddr(&ShimDMAInst_6_0,  /* bd */ 1, HIGH_ADDR((u64)0x20100007000), LOW_ADDR((u64)0x20100007000),  /* len */ 256 * 4);
XAieDma_ShimBdSetAxi(&ShimDMAInst_6_0, /* bd */ 1, /* smid */ 0, /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0, /* secure */ XAIE_ENABLE);
XAieDma_ShimBdSetNext(&ShimDMAInst_6_0,  /* bd */ 1,  /* nextbd */ 1);
XAieDma_ShimBdWrite(&ShimDMAInst_6_0,  /* bd */ 1);
...
XAieDma_ShimSetStartBd(&ShimDMAInst_6_0, XAIEDMA_SHIM_CHNUM_S2MM0,  /* bd */ 1);
XAieDma_ShimChControl(&ShimDMAInst_6_0, XAIEDMA_TILE_CHNUM_S2MM0, /* PauseStream */ XAIE_DISABLE, /* PauseMM */ XAIE_DISABLE, /* Enable */ XAIE_ENABLE);
...
int32_t mlir_aie_read_buffer_a(aie_libxaie_ctx_t* ctx, int index) {
  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[7][2]), a_offset + (index*4));
  return value;
}
void mlir_aie_write_buffer_a(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
  return XAieTile_DmWriteWord(&(ctx->TileInst[7][2]), a_offset + (index*4), int_value);
}
const int b_offset = 5120;
int32_t mlir_aie_read_buffer_b(aie_libxaie_ctx_t* ctx, int index) {
  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[7][2]), b_offset + (index*4));
  return value;
}
void mlir_aie_write_buffer_b(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
  return XAieTile_DmWriteWord(&(ctx->TileInst[7][2]), b_offset + (index*4), int_value);
}
const int acc_offset = 4096;
int32_t mlir_aie_read_buffer_acc(aie_libxaie_ctx_t* ctx, int index) {
  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[7][3]), acc_offset + (index*4));
  return value;
}
void mlir_aie_write_buffer_acc(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
  return XAieTile_DmWriteWord(&(ctx->TileInst[7][3]), acc_offset + (index*4), int_value);
}
const int c_offset = 5120;
int32_t mlir_aie_read_buffer_c(aie_libxaie_ctx_t* ctx, int index) {
  int32_t value = XAieTile_DmReadWord(&(ctx->TileInst[7][3]), c_offset + (index*4));
  return value;
}
void mlir_aie_write_buffer_c(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
  return XAieTile_DmWriteWord(&(ctx->TileInst[7][3]), c_offset + (index*4), int_value);
}
