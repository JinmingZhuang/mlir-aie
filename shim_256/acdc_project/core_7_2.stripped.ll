...
define void @core72() local_unnamed_addr {
  ...
  tail call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([256 x i32]* @acc to i64), i64 31), i64 0))
  tail call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([256 x i32]* @c to i64), i64 31), i64 0))
  tail call void @llvm.aie.lock.acquire.reg(i32 18, i32 1)
  tail call void @llvm.aie.lock.acquire.reg(i32 19, i32 1)
  tail call void @llvm.aie.lock.acquire.reg(i32 34, i32 1)
  tail call void @extern_kernel(i32* getelementptr inbounds ([256 x i32], [256 x i32]* @a, i64 0, i64 0), i32* getelementptr inbounds ([256 x i32], [256 x i32]* @b, i64 0, i64 0), i32* getelementptr inbounds ([256 x i32], [256 x i32]* @acc, i64 0, i64 0), i32* getelementptr inbounds ([256 x i32], [256 x i32]* @c, i64 0, i64 0))
  tail call void @llvm.aie.lock.release.reg(i32 18, i32 0)
  tail call void @llvm.aie.lock.release.reg(i32 19, i32 0)
  tail call void @llvm.aie.lock.release.reg(i32 34, i32 0)
