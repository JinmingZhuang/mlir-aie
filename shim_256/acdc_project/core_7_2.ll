...
@acc = external global [256 x i32]
@c = external global [256 x i32]
...
define void @core72() !dbg !3 {
  ...
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([256 x i32]* @acc to i64), i64 31), i64 0)), !dbg !10
  call void @llvm.assume(i1 icmp eq (i64 and (i64 ptrtoint ([256 x i32]* @c to i64), i64 31), i64 0)), !dbg !11
  ...
  call void @extern_kernel(i32* getelementptr inbounds ([256 x i32], [256 x i32]* @a, i64 0, i64 0), i32* getelementptr inbounds ([256 x i32], [256 x i32]* @b, i64 0, i64 0), i32* getelementptr inbounds ([256 x i32], [256 x i32]* @acc, i64 0, i64 0), i32* getelementptr inbounds ([256 x i32], [256 x i32]* @c, i64 0, i64 0)), !dbg !15
...
!4 = !DIFile(filename: "acdc_project/core_7_2.opt.mlir", directory: "/proj/rdi/staff/jinmingz/nobkup/mlir-aie/test/unit_tests/chess_compiler_tests/shim_256")
