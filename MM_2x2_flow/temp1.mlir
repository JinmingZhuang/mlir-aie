module @test_single_kernel {
  ...
  %14 = AIE.buffer(%8) {sym_name = "buf72_0"} : memref<1024xi32>
  %15 = AIE.buffer(%8) {sym_name = "buf72_1"} : memref<1024xi32>
  %16 = AIE.buffer(%8) {sym_name = "buf72_2"} : memref<1024xi32>
  %17 = AIE.buffer(%8) {sym_name = "buf72_3"} : memref<1024xi32>
  %18 = AIE.buffer(%2) {sym_name = "buf63_0"} : memref<1024xi32>
  %19 = AIE.buffer(%2) {sym_name = "buf63_1"} : memref<1024xi32>
  %20 = AIE.buffer(%2) {sym_name = "buf63_2"} : memref<1024xi32>
  %21 = AIE.buffer(%2) {sym_name = "buf63_3"} : memref<1024xi32>
  %22 = AIE.buffer(%4) {sym_name = "buf64_0"} : memref<1024xi32>
  %23 = AIE.buffer(%4) {sym_name = "buf64_1"} : memref<1024xi32>
  %24 = AIE.buffer(%4) {sym_name = "buf64_2"} : memref<1024xi32>
  %25 = AIE.buffer(%10) {sym_name = "buf73_0"} : memref<1024xi32>
  %26 = AIE.buffer(%10) {sym_name = "buf73_1"} : memref<1024xi32>
  %27 = AIE.buffer(%10) {sym_name = "buf73_2"} : memref<1024xi32>
  %28 = AIE.buffer(%10) {sym_name = "buf73_3"} : memref<1024xi32>
  %29 = AIE.buffer(%12) {sym_name = "buf74_0"} : memref<1024xi32>
  %30 = AIE.buffer(%12) {sym_name = "buf74_1"} : memref<1024xi32>
  %31 = AIE.buffer(%12) {sym_name = "buf74_2"} : memref<1024xi32>
  %32 = AIE.mem(%8) {
    %53 = AIE.lock(%8, 4)
    %54 = AIE.lock(%8, 5)
    %55 = AIE.lock(%8, 6)
