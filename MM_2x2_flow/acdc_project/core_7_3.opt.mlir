module @test_single_kernel attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.mlir.global external @buf72_0() : !llvm.array<1024 x i32>
  llvm.mlir.global external @buf72_1() : !llvm.array<1024 x i32>
  llvm.mlir.global external @buf72_2() : !llvm.array<1024 x i32>
  llvm.mlir.global external @buf72_3() : !llvm.array<1024 x i32>
  llvm.mlir.global external @buf63_0() : !llvm.array<1024 x i32>
  llvm.mlir.global external @buf63_1() : !llvm.array<1024 x i32>
  llvm.mlir.global external @buf63_2() : !llvm.array<1024 x i32>
  llvm.mlir.global external @buf63_3() : !llvm.array<1024 x i32>
  ...
  llvm.func @core73() {
    ...
    %5 = llvm.mlir.addressof @buf73_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %12 = llvm.mlir.addressof @buf73_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %17 = llvm.mlir.addressof @buf73_2 : !llvm.ptr<array<1024 x i32>>
    ...
    %22 = llvm.mlir.addressof @buf73_3 : !llvm.ptr<array<1024 x i32>>
    ...
    %27 = llvm.mlir.addressof @buf63_0 : !llvm.ptr<array<1024 x i32>>
    %28 = llvm.getelementptr %27[%6, %6] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %29 = llvm.ptrtoint %28 : !llvm.ptr<i32> to i64
    %30 = llvm.and %29, %8  : i64
    %31 = llvm.icmp "eq" %30, %6 : i64
    "llvm.intr.assume"(%31) : (i1) -> ()
    %32 = llvm.mlir.addressof @buf63_1 : !llvm.ptr<array<1024 x i32>>
    %33 = llvm.getelementptr %32[%6, %6] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %34 = llvm.ptrtoint %33 : !llvm.ptr<i32> to i64
    %35 = llvm.and %34, %8  : i64
    %36 = llvm.icmp "eq" %35, %6 : i64
    "llvm.intr.assume"(%36) : (i1) -> ()
    %37 = llvm.mlir.addressof @buf63_2 : !llvm.ptr<array<1024 x i32>>
    %38 = llvm.getelementptr %37[%6, %6] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %39 = llvm.ptrtoint %38 : !llvm.ptr<i32> to i64
    %40 = llvm.and %39, %8  : i64
    %41 = llvm.icmp "eq" %40, %6 : i64
    "llvm.intr.assume"(%41) : (i1) -> ()
    %42 = llvm.mlir.addressof @buf63_3 : !llvm.ptr<array<1024 x i32>>
    %43 = llvm.getelementptr %42[%6, %6] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %44 = llvm.ptrtoint %43 : !llvm.ptr<i32> to i64
    %45 = llvm.and %44, %8  : i64
    %46 = llvm.icmp "eq" %45, %6 : i64
    "llvm.intr.assume"(%46) : (i1) -> ()
    %47 = llvm.mlir.addressof @buf72_0 : !llvm.ptr<array<1024 x i32>>
    %48 = llvm.getelementptr %47[%6, %6] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %49 = llvm.ptrtoint %48 : !llvm.ptr<i32> to i64
    %50 = llvm.and %49, %8  : i64
    %51 = llvm.icmp "eq" %50, %6 : i64
    "llvm.intr.assume"(%51) : (i1) -> ()
    %52 = llvm.mlir.addressof @buf72_1 : !llvm.ptr<array<1024 x i32>>
    %53 = llvm.getelementptr %52[%6, %6] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %54 = llvm.ptrtoint %53 : !llvm.ptr<i32> to i64
    %55 = llvm.and %54, %8  : i64
    %56 = llvm.icmp "eq" %55, %6 : i64
    "llvm.intr.assume"(%56) : (i1) -> ()
    %57 = llvm.mlir.addressof @buf72_2 : !llvm.ptr<array<1024 x i32>>
    %58 = llvm.getelementptr %57[%6, %6] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %59 = llvm.ptrtoint %58 : !llvm.ptr<i32> to i64
    %60 = llvm.and %59, %8  : i64
    %61 = llvm.icmp "eq" %60, %6 : i64
    "llvm.intr.assume"(%61) : (i1) -> ()
    %62 = llvm.mlir.addressof @buf72_3 : !llvm.ptr<array<1024 x i32>>
    %63 = llvm.getelementptr %62[%6, %6] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %64 = llvm.ptrtoint %63 : !llvm.ptr<i32> to i64
    %65 = llvm.and %64, %8  : i64
    %66 = llvm.icmp "eq" %65, %6 : i64
    "llvm.intr.assume"(%66) : (i1) -> ()
    %67 = llvm.mlir.addressof @buf74_0 : !llvm.ptr<array<1024 x i32>>
    %68 = llvm.getelementptr %67[%6, %6] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %69 = llvm.ptrtoint %68 : !llvm.ptr<i32> to i64
    %70 = llvm.and %69, %8  : i64
    %71 = llvm.icmp "eq" %70, %6 : i64
    "llvm.intr.assume"(%71) : (i1) -> ()
    %72 = llvm.mlir.addressof @buf74_1 : !llvm.ptr<array<1024 x i32>>
    %73 = llvm.getelementptr %72[%6, %6] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %74 = llvm.ptrtoint %73 : !llvm.ptr<i32> to i64
    %75 = llvm.and %74, %8  : i64
    %76 = llvm.icmp "eq" %75, %6 : i64
    "llvm.intr.assume"(%76) : (i1) -> ()
    %77 = llvm.mlir.addressof @buf74_2 : !llvm.ptr<array<1024 x i32>>
    %78 = llvm.getelementptr %77[%6, %6] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %79 = llvm.ptrtoint %78 : !llvm.ptr<i32> to i64
    %80 = llvm.and %79, %8  : i64
    %81 = llvm.icmp "eq" %80, %6 : i64
