module @test_single_kernel attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.func @core64() {
    ...
    %6 = llvm.mlir.addressof @buf63_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %13 = llvm.mlir.addressof @buf63_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %18 = llvm.mlir.addressof @buf63_2 : !llvm.ptr<array<1024 x i32>>
    ...
    %23 = llvm.mlir.addressof @buf63_3 : !llvm.ptr<array<1024 x i32>>
    ...
    %28 = llvm.mlir.addressof @buf74_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %33 = llvm.mlir.addressof @buf74_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %38 = llvm.mlir.addressof @buf74_2 : !llvm.ptr<array<1024 x i32>>
    ...
    %43 = llvm.mlir.addressof @buf64_0 : !llvm.ptr<array<1024 x i32>>
    %44 = llvm.getelementptr %43[%7, %7] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %45 = llvm.ptrtoint %44 : !llvm.ptr<i32> to i64
    %46 = llvm.and %45, %9  : i64
    %47 = llvm.icmp "eq" %46, %7 : i64
    "llvm.intr.assume"(%47) : (i1) -> ()
    %48 = llvm.mlir.addressof @buf64_1 : !llvm.ptr<array<1024 x i32>>
    %49 = llvm.getelementptr %48[%7, %7] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %50 = llvm.ptrtoint %49 : !llvm.ptr<i32> to i64
    %51 = llvm.and %50, %9  : i64
    %52 = llvm.icmp "eq" %51, %7 : i64
    "llvm.intr.assume"(%52) : (i1) -> ()
    %53 = llvm.mlir.addressof @buf64_2 : !llvm.ptr<array<1024 x i32>>
    %54 = llvm.getelementptr %53[%7, %7] : (!llvm.ptr<array<1024 x i32>>, i64, i64) -> !llvm.ptr<i32>
    ...
    llvm.call @extern_kernel(%44, %49, %24, %54) : (!llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>, !llvm.ptr<i32>) -> ()
