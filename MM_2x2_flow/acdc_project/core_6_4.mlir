module @test_single_kernel attributes {llvm.target_triple = "aie"} {
  ...
  func @core64() {
    ...
    %7 = memref.get_global @buf64_0 : memref<1024xi32>
    memref.assume_alignment %7, 32 : memref<1024xi32>
    %8 = memref.get_global @buf64_1 : memref<1024xi32>
    memref.assume_alignment %8, 32 : memref<1024xi32>
    %9 = memref.get_global @buf64_2 : memref<1024xi32>
    ...
    %10 = arith.index_cast %c3 : index to i32
    ...
    %13 = arith.index_cast %c18 : index to i32
    %c0_i32 = arith.constant 0 : i32
    call @llvm.aie.lock.acquire.reg(%13, %c0_i32) : (i32, i32) -> ()
    call @extern_kernel(%7, %8, %3, %9) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
