module @test_single_kernel attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.func @core73() {
    ...
    %27 = llvm.mlir.addressof @buf74_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %32 = llvm.mlir.addressof @buf74_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %37 = llvm.mlir.addressof @buf74_2 : !llvm.ptr<array<1024 x i32>>
