module @test_single_kernel attributes {llvm.data_layout = "", llvm.target_triple = "aie"} {
  ...
  llvm.func @core74() {
    ...
    %6 = llvm.mlir.addressof @buf73_0 : !llvm.ptr<array<1024 x i32>>
    ...
    %13 = llvm.mlir.addressof @buf73_1 : !llvm.ptr<array<1024 x i32>>
    ...
    %18 = llvm.mlir.addressof @buf73_2 : !llvm.ptr<array<1024 x i32>>
    ...
    %23 = llvm.mlir.addressof @buf73_3 : !llvm.ptr<array<1024 x i32>>
