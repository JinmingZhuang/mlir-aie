...
XAieDma_ShimBdSetLock(&ShimDMAInst_7_0,  /* bd */ 0,  /* lockID */ 0, XAIE_ENABLE,  /* release */ 0, XAIE_ENABLE,  /* acquire */ 1);
XAieDma_ShimBdSetAddr(&ShimDMAInst_7_0,  /* bd */ 0, HIGH_ADDR((u64)0x20100002000), LOW_ADDR((u64)0x20100002000),  /* len */ 1025 * 4);
XAieDma_ShimBdSetAxi(&ShimDMAInst_7_0, /* bd */ 0, /* smid */ 0, /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0, /* secure */ XAIE_ENABLE);
XAieDma_ShimBdSetNext(&ShimDMAInst_7_0,  /* bd */ 0,  /* nextbd */ 1);
XAieDma_ShimBdWrite(&ShimDMAInst_7_0,  /* bd */ 0);
XAieDma_ShimBdSetLock(&ShimDMAInst_7_0,  /* bd */ 1,  /* lockID */ 1, XAIE_ENABLE,  /* release */ 0, XAIE_ENABLE,  /* acquire */ 1);
XAieDma_ShimBdSetAddr(&ShimDMAInst_7_0,  /* bd */ 1, HIGH_ADDR((u64)0x20100004000), LOW_ADDR((u64)0x20100004000),  /* len */ 1025 * 4);
XAieDma_ShimBdSetAxi(&ShimDMAInst_7_0, /* bd */ 1, /* smid */ 0, /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0, /* secure */ XAIE_ENABLE);
XAieDma_ShimBdSetNext(&ShimDMAInst_7_0,  /* bd */ 1,  /* nextbd */ 0);
XAieDma_ShimBdWrite(&ShimDMAInst_7_0,  /* bd */ 1);
XAieDma_ShimBdSetLock(&ShimDMAInst_7_0,  /* bd */ 2,  /* lockID */ 2, XAIE_ENABLE,  /* release */ 0, XAIE_ENABLE,  /* acquire */ 1);
XAieDma_ShimBdSetAddr(&ShimDMAInst_7_0,  /* bd */ 2, HIGH_ADDR((u64)0x20100006000), LOW_ADDR((u64)0x20100006000),  /* len */ 1025 * 4);
XAieDma_ShimBdSetAxi(&ShimDMAInst_7_0, /* bd */ 2, /* smid */ 0, /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0, /* secure */ XAIE_ENABLE);
XAieDma_ShimBdSetNext(&ShimDMAInst_7_0,  /* bd */ 2,  /* nextbd */ 3);
XAieDma_ShimBdWrite(&ShimDMAInst_7_0,  /* bd */ 2);
XAieDma_ShimBdSetLock(&ShimDMAInst_7_0,  /* bd */ 3,  /* lockID */ 3, XAIE_ENABLE,  /* release */ 0, XAIE_ENABLE,  /* acquire */ 1);
XAieDma_ShimBdSetAddr(&ShimDMAInst_7_0,  /* bd */ 3, HIGH_ADDR((u64)0x20100008000), LOW_ADDR((u64)0x20100008000),  /* len */ 1025 * 4);
XAieDma_ShimBdSetAxi(&ShimDMAInst_7_0, /* bd */ 3, /* smid */ 0, /* burstlen */ 4, /* QOS */ 0, /* Cache */ 0, /* secure */ XAIE_ENABLE);
XAieDma_ShimBdSetNext(&ShimDMAInst_7_0,  /* bd */ 3,  /* nextbd */ 2);
XAieDma_ShimBdWrite(&ShimDMAInst_7_0,  /* bd */ 3);
...
XAieDma_ShimSetStartBd(&ShimDMAInst_7_0, XAIEDMA_SHIM_CHNUM_MM2S1,  /* bd */ 2);
