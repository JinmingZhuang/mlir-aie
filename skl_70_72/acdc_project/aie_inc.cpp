...
XAieDma_TileBdSetLock(&(ctx->TileDMAInst[7][2]),  /* bd */ 0, XAIEDMA_TILE_BD_ADDRA,  /* lockID */ 0, XAIE_ENABLE,  /* release */ 1, XAIE_ENABLE,  /* acquire */ 0);
...
XAieDma_TileBdSetLock(&(ctx->TileDMAInst[7][2]),  /* bd */ 1, XAIEDMA_TILE_BD_ADDRA,  /* lockID */ 1, XAIE_ENABLE,  /* release */ 1, XAIE_ENABLE,  /* acquire */ 0);
